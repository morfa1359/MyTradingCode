...
input int Stop_Loss   = 230; // Stop Loss [point]
...
static input string IndicatorName0 = "Projection Bands v3"; // ------ Indicator parameters ------
input int Slot0IndParam0 = 23; // Period
static input string IndicatorName1 = "Account Percent Stop"; // ------ Indicator parameters ------
input double Slot1IndParam0 = 10.36; // Account percent
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   Strategy *strategy = new Strategy(0, 0);

   strategy.StrategyName           = "50-100";
   ...
   strategy.Description            = "Exported on 1/1/2025 from Forex Strategy Builder Professional, v4.3.3";
   strategy.RecommendedBars        = 1000;
   strategy.FirstBar               = 48;
   strategy.MinBarsRequired        = 51;
   ...
   strategy.Slot[0].IndicatorName    = "Projection Bands v3";
   ...
   strategy.Slot[0].IndicatorPointer = indicatorManager.CreateIndicator("Projection Bands v3", SlotTypes_Open);
   ...
   strategy.Slot[0].IndicatorPointer.ListParam[0].Text    = "Enter long at the Lower Band";
   ...
   strategy.Slot[1].IndicatorName    = "Account Percent Stop";
   ...
   strategy.Slot[1].IndicatorPointer = indicatorManager.CreateIndicator("Account Percent Stop", SlotTypes_Close);
   ...
   strategy.Slot[1].IndicatorPointer.ListParam[0].Text    = "Limit the risk to percent of the account";

   strategy.Slot[1].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[1].IndicatorPointer.NumParam[0].Caption = "Account percent";
...
/*STRATEGY CODE <?xml version=\"1.0\"?><strategy><programName>Forex Strategy Builder Professional</programName><programVersion>v4.3.3</programVersion><strategyName>50-100</strategyName><profileName>Default profile</profileName><dataSourceName>Aron Markets MT5</dataSourceName><instrumentSymbol>EURUSD.</instrumentSymbol><instrumentPeriod>15</instrumentPeriod><sameDirSignalAction>Nothing</sameDirSignalAction><oppDirSignalAction>Nothing</oppDirSignalAction><maxOpenLots>0.1</maxOpenLots><useAccountPercentEntry>False</useAccountPercentEntry><entryLots>0.01</entryLots><addingLots>0.1</addingLots><reducingLots>0.1</reducingLots><useMartingale>False</useMartingale><martingaleMultiplier>2</martingaleMultiplier><description>Exported on 1/1/2025 from Forex Strategy Builder Professional, v4.3.3</description><recommendedBars>1000</recommendedBars><openFilters>0</openFilters><closeFilters>0</closeFilters><firstBar>48</firstBar><minBarsRequired>51</minBarsRequired><permanentStopLoss usePermanentSL=\"True\" permanentSLType=\"Relative\">230</permanentStopLoss><permanentTakeProfit usePermanentTP=\"True\" permanentTPType=\"Relative\">500</permanentTakeProfit><breakEven useBreakEven=\"False\">1000</breakEven><slot slotNumber=\"0\" slotType=\"Open\"><indicatorName>Projection Bands v3</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>1</index><value>Enter long at the Lower Band</value></listParam><numParam paramNumber=\"0\"><caption>Period</caption><value>23</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"1\" slotType=\"Close\"><indicatorName>Account Percent Stop</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Limit the risk to percent of the account</value></listParam><numParam paramNumber=\"0\"><caption>Account percent</caption><value>10.36</value></numParam></slot></strategy> */
//+------------------------------------------------------------------+
